                ...
                <div className="max-w-md mx-auto">
                    ...
                    <form className="space-y-5">
                        <div>
                            ...
                            <input type="text" required placeholder="Enter full name" className="w-full mt-1 p-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:outline-none" />
                        </div>
                         <div>
                        ...
                        <div>
                            ...
                            <div className="flex">
                                ...
                                <input type="tel" required className="w-full p-3 rounded-r-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:outline-none" />
                            </div>
                        </div>
                        <div>
